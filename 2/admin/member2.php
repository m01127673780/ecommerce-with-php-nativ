          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10 col-md-6">
              <input type="text" name="full" class="form-control" minlength="12"  required/>
               ...
               <!--start Full field-->
                    <div class="form-group row">
                        <label for="FullName" class="col-sm-1 col-form-label">User Avatar</label>
                        <div class="col-sm-11 col-md-6 input-group-lg">
                            <input type="file" name="avatar" class="form-control"    placeholder="FullName"     >
                            <!--<span class="et-icon  fa   fa-user-secret  ">  </span>-->
                            <span class="  fa  icon-happy et-icon  ">  </span>
                        </div>
                    </div>
                    <!--End  Full field-->
    ...
    elseif($action == 'insert'){
         ...
         if(empty($form_errors)){
                ...
                if(empty($check)){
                   ...
                   $stmt = $con->prepare("insert into users (username, password, email, image, fullname, regstatus, date) values(?,?,?,?,?, 1,now())");
                   $stmt->execute(array($filter_user, $pass1, $filter_email, $image, $filter_full ));
                   $count = $stmt->rowCount();
